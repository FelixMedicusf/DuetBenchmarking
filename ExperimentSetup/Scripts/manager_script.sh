...
cd ~/ycsb-0.17.0 && ./bin/ycsb load basic -P workloads/workloada -p recordcount=$totalNumberOfOperations > ~/load_operations.dat
cd ~/ycsb-0.17.0 && ./bin/ycsb run basic -P workloads/workloada -p recordcount=$totalNumberOfOperations > ~/run_operations.dat
...
# cd ~/DuetBenchmarking/BenchmarkingClient/BenchmarkingManager/jar && java -jar BenchmarkingWorker-final-worker.jar > ~/worker$i.log &"
