...
gcloud compute ssh --zone $zone $currentInstanceName -- 'cd ~/DuetBenchmarking/BenchmarkingClient/BenchmarkingWorker/jar && sudo screen -mdS "BenchmarkingWorker" java -jar BenchmarkingWorker-final-worker.jar'
